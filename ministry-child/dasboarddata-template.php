<?php
/**
 * Template Name: Dashboard Data Template
 *
 * @package WordPress
...
<div id="filterdashboard" class="portfolio-filter portfolioFilter1 container-fluid clearfix">
            <ul id="filters">
				
                <li class="col-md-3">
                   <div class="maroon">
                       <a href="#" data-filter="*" class=" ">GROSS DOMESTIC PRODUCT</a>
                   </div>
                </li>
                <li class="col-md-3">
                   <div class="red">
                        <a href="#" data-filter=".fdi">FOREIGN DIRECT INVESTMENT</a>
                   </div>
                </li>
                <li class="col-md-3">
                   <div class="darkorange">
                        <a href="#"data-filter=".ranking">RANKING</a>
                   </div>
                </li>
                <li class="col-md-3">
                    <div class="lightorange">
                        <a href="#" data-filter=".indicators">OTHER INDICATORS</a>
                    </div>
                </li>
            </ul>
        </div>
   <!-- filter navigation ENDS------> 
	<!-- Dashboard Masonry STARTS--------->
		<div class="grid portfolioContainer1 custom-container">
                    ...
                    <div class="col-xs-12 col-md-3 div-mb gdp">
                      <div class="masonry-content1 greyBox1 gdpcustombg2">
						  ...
						  <p style="color: #fff;">Apr - Aug, Billion US$</p>
                            <h2 class="percentage-style">115</h2>
                      </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-3 div-mb gdp">
                      <div class="masonry-content1 greyBox1 gdpcustombg3">
						  ...
						  <p style="color: #fff;">Apr - Aug, Billion US$</p>
                            <h2 class="percentage-style"> 182.3</h2>
			...
			<div class="col-xs-12 col-md-3 div-mb fdi">
               ...
               <div class="col-xs-12 col-md-3 div-mb fdi">
                      <div class="masonry-content1 greyBox1">
						   ...
						   <p>April – Sept, 2017 ; Billion US$</p>
			...
			<div class="col-xs-12 col-md-3 div-mb indicators">
                ...
                <div class="col-xs-12 col-md-3 div-mb indicators">
                      <div class="masonry-content1 greyBox1">
                            ...
                            <ul>
                                <li>US$1 - INR<span>64.69</span></li>
