...
<!--<div id = "myDiv"><img id = "myImage" src = "http://blahworks.in/mea/wp-content/uploads/2017/08/preLoader-1.gif" width="100%"></div>-->
        ...
        <nav class="navbar <?php echo $navclass; ?>">
            <div class="<?php echo esc_attr( vct_get_header_container_class() ); ?>">
                <div class="navbar-wrapper clearfix">
					...
					<?php //if(get_field('hide_breadcrumbs')[0] !='Hide'){?><div class="customBrc <?php echo $brdcClass;?>">
